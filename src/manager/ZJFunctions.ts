class ZijieScreenBtn extends game.BaseContainer_wx5{
    ...
    public awardPublish(coin,fun:Function){
        this.publish(()=>{
            UM_wx5.addCoin(coin);
            MyWindow.ShowTips('发布成功，获得金币：'+MyTool.createHtml('+' + NumberUtil_wx5.addNumSeparator(coin,2),0xFFFF00),1000)
            fun && fun();
        })
    }
