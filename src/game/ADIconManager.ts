class ADIconManager {
    ...
    public init(){
        ...
        var wx = window['wx'];
        if (wx && wx.createGameIcon) {

            /////////////////////////////////////////
            var addY = ((GameManager_wx5.uiHeight - 230 - 700)/2 + 230) - 150
            ...
            /////////////////////////////////////////
            var styleArr = [];
            var startY = (GameManager_wx5.uiHeight - 660)/2 + 85 - 20
            ...
            /////////////////////////////////////////
            var styleArr = [];
            var startY = GameManager_wx5.uiHeight - 420
    ...
    private getStyle(x,y){
        ...
        return {
            ...
            borderColor:0,
            left:x*scalex,
            top:(y+GameManager_wx5.paddingTop())*scalex,
        }
    }
