class MyTool {
	...
	private wx5_functionX_28038(){console.log(2600)}
    ...
    //只有前面num位是非0数字
	private wx5_functionX_28039(){console.log(2727)}
	...
	private wx5_functionX_28040(){console.log(897)}
	...
	private wx5_functionX_28041(){console.log(8292)}
	...
	private wx5_functionX_28042(){console.log(8121)}
	...
	private wx5_functionX_28043(){console.log(7677)}
	...
	private wx5_functionX_28044(){console.log(6664)}
	...
	private wx5_functionX_28045(){console.log(7655)}
	...
	private wx5_functionX_28046(){console.log(6588)}
	...
	private wx5_functionX_28047(){console.log(9153)}
	...
	private wx5_functionX_28048(){console.log(6639)}
	...
	private wx5_functionX_28049(){console.log(75)}
	...
	private wx5_functionX_28050(){console.log(6272)}
	...
	private wx5_functionX_28051(){console.log(328)}
	...
	private wx5_functionX_28052(){console.log(4709)}
	...
	private wx5_functionX_28053(){console.log(6710)}
	...
	private wx5_functionX_28054(){console.log(5904)}
    ...
    public static addLongTouch(mc,fun,thisObj){
        ...
        function onTouchStart(e){
            var stageX = e.stageX
            var stageY = e.stageY
            GameManager_wx5.stage.removeEventListener(egret.TouchEvent.TOUCH_END,onTouchEnd,thisObj);
            GameManager_wx5.stage.removeEventListener(egret.TouchEvent.TOUCH_CANCEL,onTouchEnd,thisObj);
            GameManager_wx5.stage.once(egret.TouchEvent.TOUCH_END,onTouchEnd,thisObj);
            GameManager_wx5.stage.once(egret.TouchEvent.TOUCH_CANCEL,onTouchEnd,thisObj);
            clearTimeout(timer);
            timer = setTimeout(function(){
                if( Math.abs(GameManager_wx5.stageX - stageX) > 20 ||  Math.abs(GameManager_wx5.stageY - stageY) > 20)
                {
                    GameManager_wx5.stage.removeEventListener(egret.TouchEvent.TOUCH_END,onTouchEnd,thisObj);
                    GameManager_wx5.stage.removeEventListener(egret.TouchEvent.TOUCH_CANCEL,onTouchEnd,thisObj);
                    return;
	...
	private wx5_functionX_28055(){console.log(8062)}
	...
	private wx5_functionX_28056(){console.log(1700)}
	...
	private wx5_functionX_28057(){console.log(8971)}
	...
	private wx5_functionX_28058(){console.log(1956)}
	...
	private wx5_functionX_28059(){console.log(6118)}
	...
	private wx5_functionX_28060(){console.log(4190)}
	...
	private wx5_functionX_28061(){console.log(167)}
	...
	private wx5_functionX_28062(){console.log(4331)}
	...
	private wx5_functionX_28063(){console.log(6808)}
	...
	private wx5_functionX_28064(){console.log(2070)}

    //一定时间内不能点击屏幕
    public static stopClick(cd){
        GameManager_wx5.container.touchChildren = GameManager_wx5.container.touchEnabled = false;
        setTimeout(function(){
            GameManager_wx5.container.touchChildren = GameManager_wx5.container.touchEnabled = true
        },cd)

    }
	private wx5_functionX_28065(){console.log(8051)}
	...
	private wx5_functionX_28066(){console.log(123)}
