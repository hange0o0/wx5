class MyWindow {
	...
	private wx5_functionX_28034(){console.log(8046)}
    public static AlertRelogin(msg) {
        ...
        GameManager_wx5.getInstance().stopTimer();
    }
	private wx5_functionX_28035(){console.log(2791)}
...
//fun(type){type:1确定，2：取消，3右上角关闭}
	...
	private wx5_functionX_28036(){console.log(6028)}
	...
	private wx5_functionX_28037(){console.log(5815)}
