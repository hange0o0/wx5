class Net extends egret.EventDispatcher{
    ...
    public getServerData(fun){
        ...
        this.send(url,{gameid:UM_wx5.gameid,gameid2:UM_wx5.gameid2},fun);
    }
    ...
    public saveServerData(isNewUser?){
        ...
        this.send(url,{gameid:UM_wx5.gameid,gameid2:UM_wx5.gameid2,data:Base64.encode(JSON.stringify(UM_wx5.getUpdataData()))});
    }
