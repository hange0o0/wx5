 ...
 */
class StringUtil {
	private wx5_functionX_28219(){console.log(9271)}
	public constructor() {
	}
	...
	/**
		 * 获取指定宽度的字符串
		 * @param str 源字符串
	private wx5_functionX_28220(){console.log(3011)}
		 * @param textfield 宽度
	...
	private wx5_functionX_28221(){console.log(8788)}
	...
	private wx5_functionX_28222(){console.log(3421)}
